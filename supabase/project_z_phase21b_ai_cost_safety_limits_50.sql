-- Project Z Phase 21B AI Cost, Safety, and Rate Limits
-- Corrected version: 50 teacher AI generations per hour and 200 per day.
...
select
  'Project Z Phase 21B AI cost, safety, and rate limits schema applied successfully - 50 per hour' as status,
  now() as applied_at;
