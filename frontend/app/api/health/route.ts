export async function GET() {
  ...
  return Response.json({
    ok: true,
    app: 'Project Z',
    version: 'phase-37-navigation-ux-polish',
    checks: {
